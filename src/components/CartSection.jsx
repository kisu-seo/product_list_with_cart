function CartSection({ cartItems, onRemove, onConfirm }) {
  ...
  return (
    <section
      ...
      className="mt-12 rounded-2xl bg-white p-6"
    >
      <h2 id="cart-heading" className="text-xl font-bold text-red">
      ...
      {cartItems.length === 0 ? (
        ...
        <>
              ...
              <li key={item.name} className="flex items-center justify-between gap-3 border-b border-rose-100 py-4">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="font-semibold text-rose-400">${(item.quantity * item.price).toFixed(2)}</span>
                  </div>
                </div>
                <button
                  type="button"
          ...
          <div className="flex items-center justify-center gap-2 rounded-lg bg-rose-50 py-3 text-sm text-rose-900">
